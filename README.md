...
# Results
   Training finished after **46** epochs (on Tesla T4). In every three epochs, the weights of both networks were saved. 
   After reviewing the Test images generated by the generator at every three epochs, the epoch led to the best images was obtained. In Epoch **27**, the generator generated more realistic Test images. 
